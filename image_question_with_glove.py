...
CHECKPOINT_FILEPATH = os.path.join(DIR_PATH, 'checkpoints_glove', 'weighs')
...
def decoder_training():
    ...
    steps = get_dictionary_size() // batch_size # esto tiene que ser menor o igual  # usamos // para divisià¸£à¸“n entera 40
